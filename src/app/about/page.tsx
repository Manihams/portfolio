export default function AboutPage() {
    return (
      <section className="py-12 px-8 bg-gray-50 text-gray-900 min-h-screen">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg leading-relaxed mb-4">
            I have strong foundations in <span className="font-semibold">Java, C++, HTML, CSS, and JavaScript</span>. 
            I enjoy solving complex problems through algorithms and data structures, and I love experimenting with new technologies.
          </p>
